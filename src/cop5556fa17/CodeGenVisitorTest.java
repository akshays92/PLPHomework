...
//					int pixelh = ImageSupport.getPixel(loggedImage1, 0, 1023);
//					int pixelg = ImageSupport.getPixel(loggedImage0, 0, 0);
//					System.out.println("pixelh = "+pixelh);
//					System.out.println("pixelg = "+pixelg);
//				 assertEquals(pixelg, pixelh);
//		}
		keepFrame();
	}

	@Test
	public void failed5() throws Exception {
	 ...
	 * @throws Exception
	 */
	public void imageGen71() throws Exception {
		devel = false;
		grade = true;
		String prog = "imageGen7";
		String input = prog + "\nimage[512,512] g; \n" + "g[[x,y]] = (x%20>1)?(y%20>1)? 0 : Z : Z;" + "g -> SCREEN;\n";
	...
	@Test
	public void checkConstants1() throws Exception {
		String prog = "checkConstants";
		String input = prog + " \n" + "int z = Z; z -> SCREEN;\n" + "int def_X = DEF_X; def_X -> SCREEN;\n"
				+ "int def_Y = DEF_Y; def_Y -> SCREEN;\n";
		byte[] bytecode = genCode(input);
	...
	@Test
	public void failed11() throws Exception {
		String prog = "imageTestXY";
		String input = prog
				+ " \n image[512,500] g; \n g[[x,y]] = Z; \n int foo = X; \n int bar = Y; \n foo -> SCREEN;bar -> SCREEN;";
		byte[] bytecode = genCode(input);
	...
	@Test
	public void failed41() throws Exception {
		String prog = "image10";
		String input = prog
				+ "//args: <imageURL>\nimage[1024,1024] g; \n\nimage[1024,1024] h; \ng <- @ 0;\ng -> SCREEN;\nh[[x,y]] =  g[x,Y-y];h -> SCREEN; \n";
		byte[] bytecode = genCode(input);
